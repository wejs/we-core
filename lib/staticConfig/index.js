...
var init = function init(projectPath) {
  ...
  // prepend we-core as first enabled plugin if not set
  if (configs.plugins.enabled.indexOf('we-core') == -1)
    configs.plugins.enabled.unshift('we-core');
