module.exports = {
  ...
  updated: function updatedResponse(data) {
    ...
    we.hooks.trigger('we:before:send:updatedResponse', {
      ...
      we.responses.format(res.locals.responseType, data, req, res, we);
  ...
  view: function viewResponse(data) {
    ...
    req.we.responses.format(res.locals.responseType, data, req, res, req.we);
  ...
  queryError: function queryError(err) {
    ...
    we.responses.format(res.locals.responseType, {}, req, res, we);
