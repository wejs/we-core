...
assets.addCoreAssetsFiles = function addCoreAssetsFiles(plugin) {
  var plugins = {
    ...
    'jquery-ui-timepicker': [{
      weight: 6, pluginName: 'we-core',
      path: 'files/public/vendor/jquery-ui/jquery-ui-timepicker-addon.js'
    }, {
      weight: 6, pluginName: 'we-core',
      path: 'files/public/vendor/jquery-ui/jquery-ui-timepicker-addon.css'
    }],
    'jquery-ui-timepicker.i18n': [{
      weight: 6, pluginName: 'we-core',
      path: 'files/public/vendor/jquery-ui/timepicker-i18n/jquery-ui-timepicker-addon-i18n.js'
    }],
    'jquery.tabledrag': [{
      weight: 5, pluginName: 'we-core',
    ...
    'page': [{
      weight: 5, pluginName: 'we-core',
      path: 'files/public/vendor/page.js'
    }],
