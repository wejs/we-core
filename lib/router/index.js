...
router.resourceBinder.bindUpdateResource = function bindUpdateResource(we, cfg, opts, Model) {
  ...
  router.bindRoute(we, 'put '+opts.itemRout, _.merge({
    resourceName: opts.namePrefix+opts.name,
    action: 'edit',
    controller: cfg.controller,
    model: cfg.model,
  ...
  router.bindRoute(we, 'patch '+opts.itemRout, _.merge({
    resourceName: opts.namePrefix+opts.name,
    action: 'edit',
    controller: cfg.controller,
    model: cfg.model,
...
router.parseQuery = function parseQuery(req, res, next) {
  ...
  router.parseQueryWhere(req, res, query);
