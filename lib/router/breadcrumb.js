  ...
  middlewares: {
    ...
    create: function createBreadcrumb(req, res, next) {
      res.locals.breadcrumb =
        '<ol class="breadcrumb">'+
          ...
          '">'+res.locals.__(res.locals.resourceName + '.find')+'</li>'+
          '<li href="'+req.urlBeforeAlias+'">'+res.locals.__(res.locals.resourceName + '.create')+'</li>'+
        '</ol>';
    ...
    find: function findBreadcrumb(req, res, next) {
      res.locals.breadcrumb =
        '<ol class="breadcrumb">'+
          '<li href="/">'+res.locals.__('Home')+'</li>'+
          '<li href="'+req.urlBeforeAlias+'">'+res.locals.__(res.locals.resourceName + '.find')+'</li>'+
        '</ol>';
      ...
      res.locals.breadcrumb =
        '<ol class="breadcrumb">'+
          ...
          '<li href="'+
            req.we.router.urlTo(res.locals.resourceName + '.find', req.paramsArray)+
          '">'+res.locals.__(res.locals.resourceName + '.find')+'</li>'+
          '<li href="'+req.urlBeforeAlias+'">'+req.we.utils.string(res.locals.title).truncate(25).s+'</li>'+
        '</ol>';
    ...
    edit: function editBreadcrumb(req, res, next) {
      res.locals.breadcrumb =
        '<ol class="breadcrumb">'+
          ...
          '">'+res.locals.__(res.locals.resourceName + '.find')+'</li>'+
          '<li href="'+req.urlBeforeAlias+'">'+req.we.utils.string(res.locals.title).truncate(25).s+'</li>'+
          '<li href="'+res.locals.data.getUrlPathAlias()+'">'+res.locals.__('edit')+'</li>'+
        '</ol>';
    ...
    delete: function deleteBreadcrumb(req, res, next) {
      res.locals.breadcrumb =
        '<ol class="breadcrumb">'+
          ...
          '">'+res.locals.__(res.locals.resourceName + '.find')+'</li>'+
          '<li href="'+req.urlBeforeAlias+'">'+req.we.utils.string(res.locals.title).truncate(25).s+'</li>'+
          '<li href="'+res.locals.data.getUrlPathAlias()+'">'+res.locals.__('delete')+'</li>'+
        '</ol>';
