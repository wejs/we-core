...
function We(options) {
  ...
  switch (we.config.bootstrapMode) {
    case 'install':
      we.hooks.on('bootstrap', [we.bootstrapFunctions.loadCoreFeatures, we.bootstrapFunctions.loadPluginFeatures, we.bootstrapFunctions.loadTemplateCache, we.bootstrapFunctions.instantiateModels, we.bootstrapFunctions.loadControllers, we.bootstrapFunctions.initI18n, we.bootstrapFunctions.installAndRegisterPlugins]);
      break;
    case 'complete':
    case 'full':
    case 'test':
      // full load, usefull for tests
      we.hooks.on('bootstrap', [we.bootstrapFunctions.loadCoreFeatures, we.bootstrapFunctions.loadPluginFeatures, we.bootstrapFunctions.loadTemplateCache, we.bootstrapFunctions.instantiateModels, we.bootstrapFunctions.loadControllers, we.bootstrapFunctions.initI18n, we.bootstrapFunctions.installAndRegisterPlugins, we.bootstrapFunctions.setExpressApp, we.bootstrapFunctions.passport, we.bootstrapFunctions.createDefaultFolders, we.bootstrapFunctions.registerAllViewTemplates, we.bootstrapFunctions.mergeRoutes, we.bootstrapFunctions.bindResources, we.bootstrapFunctions.bindRoutes]);
      break;
    default:
      // defaults to load for run
      we.hooks.on('bootstrap', [we.bootstrapFunctions.loadCoreFeatures, we.bootstrapFunctions.loadPluginFeatures, we.bootstrapFunctions.loadTemplateCache, we.bootstrapFunctions.instantiateModels, we.bootstrapFunctions.loadControllers, we.bootstrapFunctions.initI18n, we.bootstrapFunctions.setExpressApp, we.bootstrapFunctions.passport, we.bootstrapFunctions.createDefaultFolders, we.bootstrapFunctions.registerAllViewTemplates, we.bootstrapFunctions.mergeRoutes, we.bootstrapFunctions.bindResources, we.bootstrapFunctions.bindRoutes]);
  }
}
