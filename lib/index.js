...
we.inspect = require('./inspect').bind(we);
...
// start and load db
we.db = require('./database');

we.sanitizer = require('./sanitizer');

we.loaders = require('./loaders');
we.router = require('./router');
