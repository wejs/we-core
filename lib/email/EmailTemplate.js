...
EmailTemplate.prototype.getTemplateFolder = function getTemplateFolder(cb) {
  ...
  var themeEmailTemplateFolder = themeEngine.themes.app.config.themeFolder + '/' +
    themeEngine.themes.app.config.emailTemplates.path;
  ...
  fs.readdir(themeEmailTemplateFolder + '/' + this.templateName, function(err, result) {
    ...
    if (result && result.length) {
      ...
      self.resolvedTemplateFolder = self.defaultPath;
    }
